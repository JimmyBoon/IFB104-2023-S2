...
#      to Python programs, or to ensure that your Python program
#      receives the same document you see in your web browser.
#      However you should avoid using this option if possible
#      because it may override the wishes of the web document
#      provider!
#
