...
##### DEVELOP YOUR num_digits FUNCTION HERE
import math
...
def num_digits(number):
    ...
    return num_digits_rec(abs(number), 0)

def num_digits_rec(number, counter):
    ...
    return num_digits_rec(number, counter)

# print(f"counter: {num_digits(5461)}")
